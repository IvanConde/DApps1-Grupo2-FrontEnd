...
const styles = StyleSheet.create({
  ...
  emailText: { fontSize: 16, fontWeight: "bold", color: "#4CAF50" },
  ...
  helperText: { marginTop: 5, textAlign: "center" },
  errorText: { textAlign: "center", marginBottom: 15, fontSize: 14 },
  successText: { textAlign: "center", marginBottom: 15, fontSize: 14, color: "#4CAF50" },
  verifyButton: {
    backgroundColor: "#4CAF50",
    paddingVertical: 8,
    borderRadius: 12,
  ...
  timerText: { fontSize: 14, color: "#666", textAlign: "center" },
  resendText: { fontSize: 14, color: "#666", marginBottom: 10 },
  resendButton: { paddingVertical: 8, paddingHorizontal: 15 },
  resendButtonText: { color: "#4CAF50", fontSize: 14, fontWeight: "bold" },
  tipsCard: {
    backgroundColor: "#fff",
    marginHorizontal: 20,
    marginBottom: 15,
